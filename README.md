...
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [SQS-SNS](AWS-Esempio13-SQS-SNS/) | Integrazione serverless in cui una Lambda scrive su una coda SQS, pubblica su un topic SNS per l'invio di notifiche email e traccia le invocazioni su una tabella DynamoDB <br> **Servizi**: Lambda, SQS, SNS, DynamoDB, CloudWatch, IAM <br> Ultimo aggiornamento con test completo: Luglio 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [Wordpress](AWS-Esempio14-WordpressEFS) | Un ambiente minimale su AWS che esegue un sito WordPress <br> **Servizi**: EC2, EFS, RDS senza Balancer e senza scaling <br> Ultimo aggiornamento con test completo: Luglio 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [Scaling](AWS-Esempio15-WordpressScaling) | Una piattaforma WordPress scalabile su AWS con Scaling Automatico. Due lambda per *giocare* con lo scaling <br> **Servizi**: ALB, ASG, RDS, EFS, EC2, Lambda <br> Ultimo aggiornamento con test completo: Agosto 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [Rekognition](AWS-Esempio16-RekognitionImageDetector) | Applicazione serverless che analizza le immagini caricate su S3 con Amazon Rekognition, salva gli elementi riconosciuti su DynamoDB e marca le immagini che contengono una parola chiave parametrica. Include API REST e due pagine web Bootstrap per upload e consultazione <br> **Servizi**: Rekognition, S3, Lambda, DynamoDB, API Gateway, CloudWatch <br> Ultimo aggiornamento con test completo: Agosto 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [Textract](AWS-Esempio17-Textract) | Applicazione serverless che analizza le immagini caricate su S3 con Amazon Textract e ne estrae testo secondo schema libero o regole, salva gli elementi su un json con il risutato dell'analisi. Include API REST e sito web per upload e consultazione. <br> **Servizi**: Textract, S3, Lambda, API Gateway, CloudFront<br> Ultimo aggiornamento con test completo: Agosto 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [CloudWatchAlarmSNS](AWS-Esempio18-CloudWatchAlarmSNS) | Un sito Apache su EC2 con url che rispondono 200, 401 e 403: i log in formato JSON vanno su CloudWatch, i metric filter li trasformano in metriche e tre allarmi diversi (soglia, percentuale di errore, anomaly detection) notificano un topic SNS. Il topic manda la mail e invoca una Lambda che salva lo storico su DynamoDB, consultabile da una pagina web tramite API Gateway. Inclusi dashboard, query Logs Insights e uno script di generazione traffico <br> **Servizi**: EC2, CloudWatch Logs, CloudWatch Alarms, SNS, Lambda, DynamoDB, API Gateway, IAM, SSM <br> Ultimo aggiornamento con test completo: Settembre 2026 |
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [ConfigTagScanner](AWS-Esempio19-ConfigTagScanner) | Verifica con AWS Config, la sua regola nativa REQUIRED_TAGS e una regola custom in CloudFormation Guard per i tipi non coperti, quali risorse dell'account non hanno i tag obbligatori (`project`, `cost`, `environment`, `createdWith`, `createdBy`) in piu' regioni (Oregon, Irlanda, Francoforte, Ohio, N. Virginia) riunite da un configuration aggregator, notifica le non conformi su SNS tramite EventBridge con inoltro cross-region e include un cruscotto web Bootstrap con il dettaglio dei tag mancanti per regione e uno script di scansione da CLI <br> **Servizi**: AWS Config (recorder, managed rule, Guard custom policy rule, aggregator), S3, SNS, EventBridge, Lambda, API Gateway, IAM <br> Ultimo aggiornamento con test completo: Settembre 2026 (versione multi-regione non ancora testata con apply) |
