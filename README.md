...
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [LambdaApplication](AWS-Esempio11-LambdaApplicationS3Utils/) | Applicazione serverless completa per gestisce l'intero ciclo di vita dei file da carico, import su db, export e reportistica. <br> **Servizi**: Lambda, S3, DynamoDB, RDS, API Gateway, EventBridge, Secrets Manager, SSM, CloudWatch, IAM <br> Ultimo aggiornamento con test completo: Giugno 2026 |
