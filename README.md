...
| <img src="https://img.shields.io/badge/AWS-%23FF9900?logo=AmazonAWS&logoColor=white" height=24/> | 📁 [ConfigTagScanner](AWS-Esempio19-ConfigTagScanner) | Verifica con AWS Config e la sua regola nativa REQUIRED_TAGS quali risorse dell'account non hanno i tag obbligatori (`project`, `cost`, `environment`, `createdWith`, `createdBy`), notifica le non conformi su SNS tramite EventBridge e include un cruscotto web Bootstrap con il dettaglio dei tag mancanti e uno script di scansione da CLI <br> **Servizi**: AWS Config, S3, SNS, EventBridge, Lambda, API Gateway, IAM <br> Ultimo aggiornamento con test completo: Settembre 2026 |
