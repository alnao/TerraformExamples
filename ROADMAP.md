...
Qui elencati alcuni appunti liberi di cose che vorrei fare
    ...
    - FaceDetectors:
        una cartella (in S3?)
        tot immagini, analizza tutti i volti e trova la persona più presente >X%
        fai l'elenco di tutte le immagini che non hanno quel volto (comprese le immagini senza nessun volto)
